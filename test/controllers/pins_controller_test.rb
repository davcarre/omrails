...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { comment: @pin.comment, image: @pin.image, title: @pin.title, user_id: @pin.user_id } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { comment: @pin.comment, image: @pin.image, title: @pin.title, user_id: @pin.user_id } }
